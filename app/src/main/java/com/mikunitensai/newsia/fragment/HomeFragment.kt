...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rvnewNews.adapter = AdapterNews(arrnewNews)
        rvnewNews.layoutManager = layoutManager1

        rvbestNews.adapter = AdapterNews(arrbestNews)
        rvbestNews.layoutManager = layoutManager2

        rvNews.adapter = AdapterNews(arrNews)
